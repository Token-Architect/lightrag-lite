...
class LightRAG:
    ...
    async def apipeline_enqueue_documents(
        ...
        Args:
            ...
            entity_types: Optional list of entity types to extract for these documents
        Returns:
            str: tracking ID for monitoring processing status
        """
        # Generate track_id if not provided
        ...
        new_docs: dict[str, Any] = {
            id_: {
                ...
                "metadata": {"entity_types": entity_types} if entity_types else {},
            }
                    ...
                    async with semaphore:
                        ...
                        try:
                            ...
                            if doc_metadata is None:
                                doc_metadata = {}
                            entity_types = doc_metadata.get("entity_types")
    ...
    async def _process_extract_entities(
        ...
        try:
            ...
            if entity_types:
                ...
                global_config["addon_params"] = global_config["addon_params"].copy()
        ...
        try:
            ...
            if param.mode in ["local", "global", "hybrid", "mix"]:
                ...
                response = await use_llm_func(
                    ...
                    enable_cot=param.enable_thinking,
                    stream=param.stream,
                )
