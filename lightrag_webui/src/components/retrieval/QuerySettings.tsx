...
export default function QuerySettings() {
  ...
  return (
    <Card className="glass-card flex shrink-0 flex-col w-[280px]">
            ...
            <>
              ...
              <div className="flex items-center gap-2">
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <label htmlFor="enable_thinking" className="flex-1 ml-1 cursor-help">
                        {t('retrievePanel.querySettings.enableThinking', '思考模式')}
                      </label>
                    </TooltipTrigger>
                    <TooltipContent side="left">
                      <p>{t('retrievePanel.querySettings.enableThinkingTooltip', '控制模型是否开启思考。默认关闭。')}</p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
                <Checkbox
                  className="mr-10 cursor-pointer"
                  id="enable_thinking"
                  checked={!!querySettings.enable_thinking}
                  onCheckedChange={(checked) => handleChange('enable_thinking', !!checked)}
                />
              </div>
            </>
