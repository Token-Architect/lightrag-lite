    ...
    <div className="min-w-[300px] space-y-2 text-xs">
      ...
      <div className="space-y-1">
        ...
        <div className="text-foreground grid grid-cols-[160px_1fr] gap-1">
          ...
          <span>{status.configuration.llm_binding}: {toModelDisplay(status.configuration.llm_model, 'llm')} (#{status.configuration.max_async} Async)</span>
        </div>
      </div>
      ...
      <div className="space-y-1">
        ...
        <div className="text-foreground grid grid-cols-[160px_1fr] gap-1">
          ...
          <span>{status.configuration.embedding_binding}: {toModelDisplay(status.configuration.embedding_model, 'embedding')} (#{status.configuration.embedding_func_max_async} Async * {status.configuration.embedding_batch_num} batches)</span>
        </div>
      </div>
