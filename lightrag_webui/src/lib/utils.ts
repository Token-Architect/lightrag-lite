...
/**
 * Processes an image file: crops it to a circle and returns it as a Base64 string.
 * @param file The image file to process
 * @param size The target size (diameter) in pixels. Default is 256.
 * @returns A Promise that resolves to the Base64 string of the processed image
 */
export function processImageToCircle(file: File, size: number = 256): Promise<string> {
